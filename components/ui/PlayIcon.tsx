  ...
  return (
    ...
    >
      <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        {/* Circle: white by default, blue on hover */}
        <circle 
          cx="36.5" 
          cy="36.5" 
          r="36.5" 
          className="fill-white group-hover:fill-[#0000FF] transition-colors duration-300"
        />
        {/* Triangle: always transparent so video thumbnail shows through */}
        <path 
